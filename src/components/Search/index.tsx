...
const Search = () => {
  ...
  return (
    <div className='relative flex'>
      <button
        className='-mr-8 block md:hidden lg:hidden'
      ...
      <div className={`md:block ${showSearchBar ? '' : 'hidden'}`}>
        <input
          className='w-full pl-12 pr-4 py-2 text-gray-700 bg-primaryWhite rounded-md border-primaryWhite border-2 focus:outline-none focus:shadow-outline placeholder-gray-300 text-sm sm:text-base'
          type='text'
          placeholder='Search...'
        />
      </div>
